...
pub static mut HASH_PIECE: [[[i32; 64]; 6]; 2] = [[[0; 64]; 6]; 2];
pub static mut HASH_SIDE: i32 = 0;
pub static mut HASH_EP: [i32; 64] = [0; 64];
...
pub const OFFSETS: [i32; 6] = [0, 8, 4, 4, 8, 8];

pub const OFFSET: [[i32; 8]; 6] = [
    [0, 0, 0, 0, 0, 0, 0, 0],
